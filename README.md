...
**[Try it live](https://check.importflow.dev)** · **[Run it locally](#run-locally--self-host)**

[![Actual PG Import Check Decision Report for synthetic contacts: email required from source, id generated by the database, defaults and constraints requiring review](docs/demo/decision-report.png)](https://check.importflow.dev)
...
v0.3.2 is a presentation release on the unchanged **v0.3.0 engine**.
